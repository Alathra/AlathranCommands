...
import io.github.Alathra.AlathranCommands.db.flyway.DatabaseMigrationException;
import io.github.Alathra.AlathranCommands.db.flyway.DatabaseMigrationHandler;
import io.github.Alathra.AlathranCommands.db.jooq.JooqContext;
import io.github.Alathra.AlathranCommands.utility.Cfg;
...
public class DatabaseHandler implements Reloadable {
    private final AlathranCommands examplePlugin;
     ...
     */
    public DatabaseHandler(AlathranCommands examplePlugin) {
    ...
    private void openConnection() {
        ...
        hikariConfig.setPoolName("%s-hikari".formatted(AlathranCommands.getInstance().getName()));
